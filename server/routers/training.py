...
_MMACTION2_REGISTRY = [
    ...
    {
        "id": "videomae-ava-base",
        "name": "VideoMAE (AVA detection, ViT-B)",
        "family": "AVA",
        "backbone": "vit_base",
        "pretrained_source": "AVA (Kinetics)",
        "pretrained_url": "https://download.openmmlab.com/mmaction/v1.0/detection/videomae/vit-base-p16_videomae-k400-pre_8xb8-16x4x1-20e-adamw_ava-kinetics-rgb/vit-base-p16_videomae-k400-pre_8xb8-16x4x1-20e-adamw_ava-kinetics-rgb_20230314-3dafab75.pth",
        "mmaction2_config": "configs/detection/videomae/vit-base-p16_videomae-k400-pre_8xb8-16x4x1-20e-adamw_ava-kinetics-rgb.py",
        "label_map": "models/mmaction2/tools/data/ava/label_map.txt",
        "type": "detection",
        "det_config": "demo/demo_configs/faster-rcnn_r50_fpn_2x_coco_infer.py",
        "det_checkpoint": "checkpoints/faster-rcnn-coco/faster_rcnn_r50_fpn_2x_coco.pth",
        "description": "VideoMAE ViT-B AVA 检测（自监督预训练 + 人物框 + AVA 动作标签）",
    },
    {
        "id": "acrn-ava-r50",
