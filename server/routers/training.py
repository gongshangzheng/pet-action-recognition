...
_MMACTION2_REGISTRY = [
    ...
    {
        "id": "videomae-v1",
        "name": "VideoMAE v1 (ViT-B) — K400 掩码预训练",
        "family": "VideoMAE",
        "backbone": "vit-base-p16",
        "pretrained_source": "Kinetics-400 (掩码预训练→微调)",
        ...
        "mmaction2_config": "configs/pet_mammal_videomae_v1_base_16x4.py",
        "description": "VideoMAE v1 纯 K400 口径（对照 v2 的 K710 蒸馏）；backbone init_cfg 自动加载，勿选 --pretrained 模式。建议 lr=1e-4、batch=2。",
    },
    {
        "id": "uniformerv2-base",
        "name": "UniFormerV2 (ViT-B) — K710 预训练",
        "family": "UniFormerV2",
        "backbone": "uniformerv2-base-p16",
        "pretrained_source": "CLIP + Kinetics-710",
        "pretrained_url": "https://download.openmmlab.com/mmaction/v1.0/recognition/uniformerv2/kinetics710/uniformerv2-base-p16-res224_clip-pre_u8_kinetics710-rgb_20221219-77d34f81.pth",
        "mmaction2_config": "configs/pet_mammal_uniformerv2_base_8x8.py",
        "description": "图像基础模型适配视频路线代表（CLIP ViT + 时空块）；backbone init_cfg 自动加载（prefix=backbone.），head 7 类随机初始化。小数据谨慎 lr：建议 5e-5、batch=2。",
    },
    {
        "id": "aim-vitb-adapter",
        "name": "AIM (ViT-B Adapter) — 参数高效微调",
        "family": "AIM",
        "backbone": "vit-base-p16 (frozen + adapters)",
        "pretrained_source": "Kinetics-400 (掩码预训练→微调，同 videomae-v1)",
        "pretrained_url": "https://download.openmmlab.com/mmaction/v1.0/recognition/videomae/vit-base-p16_videomae-k400-pre_16x4x1_kinetics-400_20221013-860a3cd3.pth",
        "mmaction2_config": "configs/pet_mammal_aim_vitb_16x4.py",
        "description": "冻结 backbone，仅训逐 block Adapter（<10% 参数）+ 7 类头；小数据防过拟合。接入前跑 scripts/assert_aim_frozen.py 校验冻结；lr=1e-3（仅 Adapter/头）。",
    },
    {
        "id": "posec3d-quadruped",
        "name": "PoseC3D 式 SlowOnly (17 点四足骨架)",
        "family": "PoseC3D",
        "backbone": "resnet3d-slowonly (keypoint heatmap)",
    ...
    {
        "id": "slowfast-ava-r50",
        "name": "SlowFast (AVA detection, R50)",
        "family": "AVA",
        "backbone": "resnet50",
        "pretrained_source": "AVA v2.1",
        "pretrained_url": "https://download.openmmlab.com/mmaction/v1.0/detection/slowfast/slowfast_kinetics400-pretrained-r50_8xb16-4x16x1-20e_ava21-rgb/slowfast_kinetics400-pretrained-r50_8xb16-4x16x1-20e_ava21-rgb_20220906-5180ea3c.pth",
        "mmaction2_config": "configs/detection/slowfast/slowfast_kinetics400-pretrained-r50_8xb16-4x16x1-20e_ava21-rgb.py",
        "label_map": "models/mmaction2/tools/data/ava/label_map.txt",
        "type": "detection",
        "det_config": "demo/demo_configs/faster-rcnn_r50_fpn_2x_coco_infer.py",
        "det_checkpoint": "checkpoints/faster-rcnn-coco/faster_rcnn_r50_fpn_2x_coco.pth",
        "description": "SlowFast AVA 检测（双路径 + 人物框 + AVA 动作标签）",
    },
    {
        "id": "acrn-ava-r50",
        "name": "ACRN (AVA detection, R50)",
        "family": "AVA",
        "backbone": "resnet50",
        "pretrained_source": "AVA v2.1",
        "pretrained_url": "https://download.openmmlab.com/mmaction/v1.0/detection/acrn/slowfast-acrn_kinetics400-pretrained-r50_8xb8-8x8x1-cosine-10e_ava21-rgb/slowfast-acrn_kinetics400-pretrained-r50_8xb8-8x8x1-cosine-10e_ava21-rgb_20220906-0dae1a90.pth",
        "mmaction2_config": "configs/detection/acrn/slowfast-acrn_kinetics400-pretrained-r50_8xb8-8x8x1-cosine-10e_ava21-rgb.py",
        "label_map": "models/mmaction2/tools/data/ava/label_map.txt",
        "type": "detection",
        "det_config": "demo/demo_configs/faster-rcnn_r50_fpn_2x_coco_infer.py",
        "det_checkpoint": "checkpoints/faster-rcnn-coco/faster_rcnn_r50_fpn_2x_coco.pth",
        "description": "ACRN AVA 检测（SlowFast+ACRN + 人物框 + AVA 动作标签）",
    },
    {
        "id": "lfb-ava-r50",
        "name": "LFB (AVA detection, R50)",
        "family": "AVA",
        "backbone": "resnet50",
        "pretrained_source": "AVA v2.1",
        "pretrained_url": "https://download.openmmlab.com/mmaction/v1.0/detection/lfb/slowonly-lfb-nl_kinetics400-pretrained-r50_8xb16-4x16x1-20e_ava21-rgb/slowonly-lfb-nl_kinetics400-pretrained-r50_8xb16-4x16x1-20e_ava21-rgb_20220906-4c5b9f25.pth",
        "mmaction2_config": "configs/detection/lfb/slowonly-lfb-nl_kinetics400-pretrained-r50_8xb16-4x16x1-20e_ava21-rgb.py",
        "label_map": "models/mmaction2/tools/data/ava/label_map.txt",
        "type": "detection",
        "det_config": "demo/demo_configs/faster-rcnn_r50_fpn_2x_coco_infer.py",
        "det_checkpoint": "checkpoints/faster-rcnn-coco/faster_rcnn_r50_fpn_2x_coco.pth",
        "description": "LFB AVA 检测（SlowOnly+LFB + 人物框 + AVA 动作标签）",
    },
]
