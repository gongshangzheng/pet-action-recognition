...
CHECKPOINTS_DIR = os.path.join(TRAINING_DIR, "checkpoints")         # trained .pth state_dicts（训练产物）
PRETRAINED_DIR = os.path.join(BASE_DIR, "checkpoints")              # mmaction2 预训练权重（repo 根 ./checkpoints/，finetune 用）
