# 哺乳动物动作识别 VideoMAE 配置（ViT-B, 16 frames, 224px）
...
PRETRAINED = "checkpoints/videomae-base/videomae-base_pretrained.pth"
num_classes = 7

# model settings（与 mmaction2 videomae base 一致，仅 cls_head 改 7 类 + backbone init_cfg）
model = dict(
    type="Recognizer3D",
    backbone=dict(
